...
namespace AI_Task
{
    ...
    public class TextProgressBar : ProgressBar
    {
        ...
        {
            TextFont = new Font(FontFamily.GenericMonospace, 12, FontStyle.Bold);
            Value = Minimum;
        ...
        private void DrawStringIfNeeded(Graphics g)
        {
            if (VisualMode != ProgressBarDisplayMode.NoText)
            {
                ...
                System.Drawing.Point location = new System.Drawing.Point(((Width / 2) - (int)len.Width / 2), ((Height / 2) - (int)len.Height / 2));
